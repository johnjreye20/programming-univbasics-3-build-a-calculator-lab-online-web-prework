...
For our final method, we'll want to define the method any_phrase that takes in a phrase and outputs it.
...
This test expects any_phrase to pass in an argument called phrase, in this example assigned to "Do A Barrel Roll!". The test expects that any_phrase(phrase) will output "Do A Barrel Roll!\n".
